...
const MenuButtons = ({ onNewGame, onLoadGame, onConfiguration }) => {
    return (
        <div className="absolute inset-0 flex items-center justify-center lg:justify-start z-20 pt-32 sm:pt-40 md:pt-56 lg:pt-0 lg:left-[12%] lg:top-1/2 lg:transform lg:-translate-y-1/2">
